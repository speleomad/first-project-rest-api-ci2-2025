...
import com.example.restapicontactmanagement.web.dto.ResponseMessage;
...
public class FilesStorageController {
  ...
  public ResponseEntity<ResponseMessage> uploadFile(@PathVariable(name="id") Long id, @RequestParam("file") MultipartFile file) {
    String message = "";
    try {
